!(function (e, t) {
  ...
  class R {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = O),
        (r[11] = 0),
        (r[12] = e.x + T - (M * T + k * R + D * S)),
        (r[13] = e.y + R - (E * T + A * R + I * S)),
  ...
  class A {
    ...
    _setParent() {
      if (
        ...
        this.source
          ...
          this._setSize();
      } else "RenderTarget" === this._parent.type && ((this._size = { width: (this._parent._size && this._parent._size.width) || this.renderer._boundingRect.width, height: (this._parent._size && this._parent._size.height) || this.renderer._boundingRect.height }), this._upload(), this._updateTexParameters(), (this._canDraw = !0));
    }
    hasParent() {
      return !!this._parent;
    }
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? E.set(this._parent.scale.x, this._parent.scale.y)
          : E.set(1, 1),
    ...
    setScale(e) {
      e.type && "Vec2" === e.type
        ? (e.sanitizeNaNValuesWith(this.scale).max(E.set(0.001, 0.001)),
    ...
    _updateTextureMatrix(e) {
      ...
      (t.x /= this.scale.x),
        (t.y /= this.scale.y),
        (this._textureMatrix.matrix = k.setFromArray([
          t.x,
          0,
          0,
          0,
  ...
  class I {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (h = parseInt(h)),
        (l = parseInt(l)),
        (this._geometry = new T(this.renderer, { width: h, height: l })),
  ...
  function ve(e, t, s, i, r) {
    if (s.length > 1) {
      ...
      if (
        ("linear" === r &&
          (a = e.createLinearGradient(o - u, h - c, o + u, h + c)),
        "conic" === r)
      ) {
  ...
  function ye(e) {
    ...
    if (
      "string" == typeof e &&
      (e.includes("=>") || e.includes("function") || e.includes("x"))
    ) {
  ...
  function Re(e) {
    ...
    const t = [
      ...
      s =
        e.states &&
        [...e.states.appear, ...e.states.scroll, ...e.states.hover].length > 0,
      i =
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= ce), "scrollIntoView" === this.mode)) {
        ...
        return (
          !(
            ...
            ((n = Pe(n, this.lastTick, 2 * this.momentum)),
            Math.abs(this.lastTick - n) < fe)
          ) && ((this.lastTick = n), Ce(e, this.value, n))
        );
      }
      if ("whileScrolling" === this.mode) {
        ...
        return (
          ...
          void 0 !== this.lastTick &&
          ((t = Pe(t, this.lastTick, 2 * this.momentum)), Math.abs(t) < fe)
            ? !1
  ...
  class ze {
          ...
          ((r = e.breakpoints || []).forEach((e) => {
            ...
            for (let i in e.props)
              "Vec2" === (null == (t = e.props[i]) ? void 0 : t.type)
                ? (e.props[i] = new S(e.props[i]._x, e.props[i]._y))
        ...
        (this.states = {
          appear:
            e.states && e.states.appear
              ? e.states.appear.map((e) => new De(e))
              : [],
          scroll:
            e.states && e.states.scroll
              ? e.states.scroll.map((e) => new Ie(e))
              : [],
          hover:
            e.states && e.states.hover
              ? e.states.hover.map((e) => new Oe(e))
              : [],
        });
    }
    state() {
    ...
    updateStateEffects() {
      ...
      (this.local.cachedBreakpoint &&
        ...
        (this.local.cachedBreakpoint =
          null == (i = r.currentBreakpoint) ? void 0 : i.name);
      const n = (e) =>
        !e.breakpoints ||
        0 === e.breakpoints.length ||
        e.breakpoints.find((e) => e === this.local.cachedBreakpoint);
      r.isInView &&
        (null === this.local.createdAt && (this.local.createdAt = a),
          ...
          (this.getPlanes().forEach((e) => {
            ...
            for (let s of this.local.updatedProps) {
              ...
              void 0 !== i &&
                ...
                (e.uniforms[s] && Ae(i, e.uniforms[s], s),
  ...
  let Ue = class extends ze {
    ...
    resize() {
      ...
      (null == (t = null == (e = this.states) ? void 0 : e.appear)
        ? void 0
        : t.some((e) => !e.complete)) || this.render(),
    ...
    getAbsoluteDimensions() {
      ...
      return (
        "auto" !== this.widthMode &&
          ((a = "fixed" === this.widthMode ? l : l * o),
          "auto" === this.heightMode &&
  ...
  class Ve extends Ue {
    ...
    render() {
      ...
      let u =
          (null == (e = this.local.stateEffectProps)
            ? void 0
            : e.borderRadius) ?? this.borderRadius,
        c =
          (null == (t = this.local.stateEffectProps)
            ? void 0
            : t.strokeWidth) ?? this.strokeWidth,
        p =
          (null == (s = this.local.stateEffectProps)
            ? void 0
            : s.gradientAngle) ?? this.gradientAngle,
        m =
          (null == (i = this.local.stateEffectProps) ? void 0 : i.rotation) ??
          this.rotation,
        g = n - d.x * h,
        f = o - d.y * l;
      if (
        (r.clearRect(0, 0, a.canvasWidth, a.canvasHeight),
        r.beginPath(),
        this.fitToCanvas)
      )
        r.rect(0, 0, a.canvasWidth, a.canvasHeight),
          (r.fillStyle = ve(
            r,
            { width: a.canvasWidth, height: a.canvasHeight },
            this.fill,
            p,
            this.gradientType
          ));
      ...
      r.fill(),
        c && ((r.strokeStyle = this.stroke[0]), (r.lineWidth = c), r.stroke()),
        r.restore();
    }
    ...
    unpackage() {
      for (let e in this)
        this[e] &&
          this[e].type &&
          ("Vec2" === this[e].type
            ? (this[e] = new S(this[e]._x, this[e]._y))
            : "Vec3" === this[e].type &&
  ...
  class We extends Ue {
    constructor(e, t, i) {
      ...
      for (let s in r) this[s] = r[s];
      this.breakpoints.length && this.setBreakpointValues(),
        Object.keys(e).length && (this.createLocalCanvas(), this.loadImage());
    }
    default(e) {
      return { fitToCanvas: e.fitToCanvas || !1, src: e.src || "" };
    }
    unpackage() {
      return (this.effects = be(this.effects)), this;
    }
    loadImage() {
      const e = new Image();
  ...
  class Ne extends ze {
    constructor(e, t, i) {
      ...
      super(e, t, i),
        ...
        (this.colorMapPosition = e.colorMapPosition
          ? new S(e.colorMapPosition.x ?? 0.5, e.colorMapPosition.y ?? 0.5)
          : new S(0.5, 0.5)),
        ...
        (this.normalMapPosition = e.normalMapPosition
          ? new S(e.normalMapPosition.x ?? 0.5, e.normalMapPosition.y ?? 0.5)
          : new S(0.5, 0.5)),
    ...
    async loadRenderer() {
      ...
      let t =
        this.moduleUrl ||
        "https://cdn.jsdelivr.net/gh/hiunicornstudio/unicornstudio.js@v1.5.3/extensions/model-renderer.js";
      try {
    ...
    handleModelLoaded() {
      if (((this.local.modelLoaded = !0), this.local.renderTarget)) {
        let e = this.local.renderTarget.getTexture(),
          t = this.getPlane().textures.find(
            (e) => "uTexture" === e._samplerName
          );
        t.copy(e), t.needUpdate();
      }
    }
    renderModel() {
      var e, t;
  ...
  class He extends Ue {
    constructor(e, t, i, r) {
      super(e, t), s(this, "layerType", "text"), (this.initOptions = r);
      let a = this.default(e || {});
      for (let s in a) this[s] = a[s];
      this.breakpoints.length && this.setBreakpointValues(),
    ...
    unpackage() {
      return (
        (this.fill = be(this.fill)), (this.effects = be(this.effects)), this
      );
    }
    loadFont() {
      var e;
        ...
        for (let s = 0; s < t.length; s++) {
          ...
          if (
            ...
            if ("" !== e)
              (w[S] = e.trim()),
                s !== t.length - 1
                  ? (w.splice(S + 1, 0, t.slice(s).join("")), T++)
                  : "\n" !== r && w.push(r);
            else {
              let e = r,
                a = S;
              for (; e.length > 0; ) {
                ...
                (e = e.slice(t.length)),
                  (w[a] = t.trim()),
                  e.length > 0 && (w.splice(a + 1, 0, e), a++, T++);
              }
              t.slice(s + 1).length > 0 && (w[a] += t.slice(s + 1).join(""));
            }
            break;
          }
          (e = a), s === t.length - 1 && (w[S] = e.trim());
        }
      }
      w.forEach((e, t) => {
        P(e, p), t < w.length - 1 && p++;
      }),
    ...
    (!ge || i - ge > 64) && Ye(),
      t.forEach((e) => {
        if (Xe(e.element, e.bbox, 100)) {
          if (!e.isInView) {
            (e.isInView = !0), (e.pauseTime = e.pauseTime - i);
            const t = e.element.offsetWidth > 0 && e.element.offsetHeight > 0;
            t && e.curtain
              ? e.resize()
              : t ||
                requestAnimationFrame(() => {
                  e.element.offsetWidth > 0 &&
                    e.element.offsetHeight > 0 &&
                    e.curtain &&
                    e.resize();
                }),
              !e.lazyLoad ||
        ...
        } else e.isInView && ((e.isInView = !1), (e.pauseTime = i));
      });
  }
  function $e(e) {
  ...
  class Je {
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((e) => Re(e)).length;
        for (; s && !Re(s) && !r && !a; )
          t++,
            (s = e[t]),
            s &&
    ...
    getPlaneParams(e, t) {
      ...
      const h = {
        ...
        mousePos: { name: "uMousePos", type: "2f", value: new S(0.5) },
      ...
      e.isElement && (h.sampleBg = { name: "uSampleBg", type: "1i", value: 1 }),
        e.isModel && (h.opacity = { name: "uOpacity", type: "1f", value: 1 }),
        e.usesPingPong &&
          (h.previousMousePos = {
        ...
        for (let u in e.data.uniforms) {
          ...
          (h[u] = e.data.uniforms[u]),
            "Vec3" === (null == (a = t.value) ? void 0 : a.type)
              ...
              ? (h[u].value = new S(t.value._x, t.value._y))
              : "object" == typeof t.value && (h[u].value = be(t.value));
        }
      return {
        fragmentShader: l,
        vertexShader: d,
    ...
    createPlane(e, t, s) {
      ...
      (r =
        e.isElement || e.isModel
          ...
          : this.getPlaneParams(e, s ? s.index : null)),
        (r.watchScroll = !1);
      try {
        if (!this.curtain.container)
          throw new Error("Can't find scene container");
        let n =
            (null == s ? void 0 : s.downSample) ||
            (0 === (null == s ? void 0 : s.index) &&
              (null == (i = e.data) ? void 0 : i.downSample)),
          o = this.renderingScale;
        if (
          (n &&
            ((o = "number" == typeof n ? n : 0.5), (o *= this.renderingScale)),
          e.userDownsample &&
    ...
    createPingPongPlane(e, t, s) {
      var i;
      let r = this.getPlaneParams(
          e,
          1 + ((null == s ? void 0 : s.length) || 0)
        ),
        a =
          null == (i = this.curtain)
            ? void 0
      ...
      if (a) a.setRenderOrder(t);
      else {
        if (((a = new re(this.curtain, this.curtain.container, r)), !a)) return;
        (a.userData.id = e.local.id),
          ...
          .forEach((i) => {
            ...
            if (
              ...
              (null == t ? void 0 : t.texture)
                ? (t.count > 1
                    ? (Fe(e, i.sampler, t.texture), t.count--)
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (
        (n &&
          ...
          Fe(r, "uPingPongTexture", n.getTexture()),
    ...
    handleModelPlane(e, t) {
      ...
      i.textures.forEach((e) => {}),
        (i.textures = []),
        (null == (s = e.local.renderTarget) ? void 0 : s.getTexture) &&
        e.local.modelLoaded
    ...
    handleElementPlane(e, t) {
      ...
      let a,
        ...
        h = r[r.indexOf(e) - (1 + o)];
      if (
        (e.mask && h && (a = h.local.lastTarget),
        i.length || (s.textures.length = 0),
        n && i.length
          ? Fe(s, "uTexture", n.getTexture())
      ...
      if (
        (n && (d || s.passIndex > 0)
          ? (e.isMask &&
            ...
            Fe(r, "uTexture", n.getTexture()))
          : e.isMask
          ? (u && c && r.addTexture(a.preloadedCanvasTexture),
            n ? Fe(r, "uTexture", n.getTexture()) : Fe(r, "uTexture"))
          : (null == h ? void 0 : h.includes("uTexture")) &&
            (r.addTexture(a.preloadedCanvasTexture),
            (a.preloadedCanvasTexture.userData.used = !0)),
        o &&
          (null == h ? void 0 : h.includes("uPingPongTexture")) &&
          Fe(r, "uPingPongTexture", o.getTexture()),
        ...
        if (d && s.length > 1) {
          ...
          a.preloadedCanvasTexture.userData.used
            ? r.loadCanvas(
                a.local.canvas,
            ...
            : ((a.preloadedCanvasTexture._samplerName = "uBgTexture"),
              r.addTexture(a.preloadedCanvasTexture));
      "custom" === e.type &&
        Fe(r, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(r, e, s);
    }
    createPlanes() {
    ...
    setModelPlaneUniforms(e, t) {
      ...
      s && !t.local.mouse && (t.local.mouse = { x: 0.5, y: 0.5 }),
        s && ((t.local.mouse.x = s.x), (t.local.mouse.y = s.y)),
        e.uniforms.opacity &&
          (e.uniforms.opacity.value = t.local.modelLoaded ? t.opacity : 0);
    }
        ...
        for (let s in e.uniforms)
          (null == (r = t.states)
            ...
            (t.local.bpProps && s in t.local.bpProps
              ? Ae(t.local.bpProps[s], e.uniforms[s], s)
              : s in t && Ae(t[s], e.uniforms[s], s));
        s &&
          i &&
          i.index < i.length - 1 &&
          e.uniforms.isMask &&
    ...
    calculateItemMouseValues(e) {
      ...
      return (
        this.local.mouseValuePool || (this.local.mouseValuePool = new S(0.5)),
    ...
    getMousePosWithMomentum(e, t, s) {
      ...
      return (
        (p < fe && m < fe) ||
          (n
            ? ((i = Pe(i, u, 2 * h)), (e.local.lastMousePos.x = i / t))
            : (e.local.lastMousePos.x = 0.5),
          o
            ? ((r = Pe(r, c, 2 * h)), (e.local.lastMousePos.y = 1 - r / s))
  ...
  function st() {
    et(window, "mousemove", Ze),
      ...
      he && (et(window, "resize", he), et(window, "orientationchange", he)),
      et(document, ne, je),
      (le = !1);
  }
  function it(e) {
